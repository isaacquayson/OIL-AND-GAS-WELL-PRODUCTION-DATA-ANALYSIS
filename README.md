...
## Tool Used (Python)
Python programming language was utilized for the data analysis, visualization, and predictive modeling tasks. Key libraries included Pandas for data manipulation, Matplotlib and Seaborn for visualization, and Scikit-learn for regression modeling.
